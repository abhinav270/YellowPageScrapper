...
def parse_listing(keyword, place,page_no):
    ...
    for i in range(page_no+1):
      url = "https://www.yellowpages.com/search?search_terms={0}&geo_location_terms={1}&page={2}".format(keyword, place,i)
...
if __name__ == '__main__':
    ...
    Adf= pd.read_csv('County_State.csv')
    ...
    results = pool.map(main,list_scrapping_data)
